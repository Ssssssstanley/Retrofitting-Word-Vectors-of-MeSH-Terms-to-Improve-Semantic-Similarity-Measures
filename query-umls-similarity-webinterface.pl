...
eval(GetOptions( "version", "help", "url=s", "measure=s", "sab=s", "rel=s", "infile=s","outfile=s" ,"debug")) or die ("Please check the above mentioned option(s).\n");
